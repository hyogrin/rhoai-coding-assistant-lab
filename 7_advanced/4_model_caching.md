...
Mount the PVC in your `LLMInferenceService` or InferenceService spec:
...
oc exec -n llm-d-serving deploy/vllm-model-server -- ls -lh /mnt/models
```
...
oc get volumesnapshot model-cache-snapshot -n llm-d-serving
